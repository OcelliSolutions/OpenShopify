...
public class WebhookController : WebhookControllerBase
{
    ...
    public override Task ListWebhooks(string? address = null, DateTimeOffset? created_at_max = null,
        DateTimeOffset? created_at_min = null, string? fields = null,
        int? limit = null, string? page_info = null, long? since_id = null, string? topic = null,
    ...
    public override Task DeleteWebhook([Required] long webhook_id) => throw new NotImplementedException();
}