...
public class PriceRuleController : PriceRuleControllerBase
{
    ...
    public override Task ListPriceRules(DateTimeOffset? created_at_max = null, DateTimeOffset? created_at_min = null,
        DateTimeOffset? ends_at_max = null,
        DateTimeOffset? ends_at_min = null, int? limit = null, string? page_info = null, long? since_id = null,
        DateTimeOffset? starts_at_max = null, DateTimeOffset? starts_at_min = null,
        int? times_used = null, DateTimeOffset? updated_at_max = null, DateTimeOffset? updated_at_min = null) =>
        throw new NotImplementedException();

    /// <inheritdoc />
    [HttpPut]
    [Route("price_rules/{price_rule_id:long}.json")]
    ...
    [Route("price_rules/{price_rule_id:long}.json")]
    [ProducesResponseType(typeof(PriceRuleItem), StatusCodes.Status200OK)]
    public override Task GetPriceRule([Required] long price_rule_id) => throw new NotImplementedException();

    /// <inheritdoc />
    [HttpDelete]
    [Route("price_rules/{price_rule_id:long}.json")]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    public override Task DeletePriceRule([Required] long price_rule_id) => throw new NotImplementedException();

    /// <inheritdoc />
    [HttpGet]
    [Route("price_rules/count.json")]
    [ProducesResponseType(typeof(CountItem), StatusCodes.Status200OK)]
    public override Task CountPriceRules() => throw new NotImplementedException();
}