...
public class ProductController : ProductControllerBase
{
    ...
    [IgnoreApi]
    [HttpGet]
    [Route("products.invalid")]
    [ProducesResponseHeader("Link", StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProductList), StatusCodes.Status200OK)]
    public override Task ListProducts(long collection_id, DateTimeOffset? created_at_max = null,
        DateTimeOffset? created_at_min = null,
        string? fields = null, string? handle = null, [FromQuery] IEnumerable<long>? ids = null, int? limit = null,
    ...
    [ProducesResponseHeader("Link", StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProductList), StatusCodes.Status200OK)]
    public Task ListProducts(long? collection_id, DateTimeOffset? created_at_max = null,
        DateTimeOffset? created_at_min = null,
        string? fields = null, string? handle = null, [FromQuery] IEnumerable<long>? ids = null, int? limit = null,
        string? page_info = null,
        string? presentment_currencies = null, string? product_type = null, DateTimeOffset? published_at_max = null,
    ...
    public override Task DeleteProduct([Required] long product_id) => throw new NotImplementedException();
}