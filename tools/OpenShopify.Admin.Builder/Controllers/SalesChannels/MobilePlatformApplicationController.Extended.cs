...
public class MobilePlatformApplicationController : MobilePlatformApplicationControllerBase
{
    ...
    public override Task ListMobilePlatformApplicationsAssociatedWithApp() => throw new NotImplementedException();
    ...
    /// <inheritdoc />
    [HttpGet]
    [Route("mobile_platform_applications/{mobile_platform_application_id:long}.json")]
