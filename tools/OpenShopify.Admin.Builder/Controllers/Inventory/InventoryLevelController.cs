...
namespace OpenShopify.Admin.Builder.Models
{
    ...
    public abstract class InventoryLevelControllerBase : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        ...
        /// </summary>
        /// <param name="inventory_item_ids">A comma-separated list of inventory item IDs. To find the ID of an inventory item, use the [Inventory Item resource](/api/admin-rest/latest/resources/inventoryitem)</param>
    ...
    public partial record InventoryLevelOrig
    {
        /// <summary>
