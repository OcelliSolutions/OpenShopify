...
public class CarrierServiceController : CarrierServiceControllerBase
{
    ...
    public override Task ListCarrierServices() => throw new NotImplementedException();

    /// <inheritdoc />
    [HttpPut]
    [Route("carrier_services/{carrier_service_id:long}.json")]
    [ProducesResponseType(typeof(CarrierServiceItem), StatusCodes.Status200OK)]
    public override Task UpdateCarrierService([Required] UpdateCarrierServiceRequest request,
        [Required] long carrier_service_id) => throw new NotImplementedException();

    /// <inheritdoc />
    [HttpGet]
    [Route("carrier_services/{carrier_service_id:long}.json")]
    [ProducesResponseType(typeof(CarrierServiceItem), StatusCodes.Status200OK)]
    public override Task GetCarrierService([Required] long carrier_service_id) => throw new NotImplementedException();
