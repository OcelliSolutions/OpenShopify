...
public class CancellationRequestController : CancellationRequestControllerBase
{
    ...
    public override Task SendCancellationRequest([Required] SendCancellationRequestRequest request, long fulfillment_order_id) =>
        throw new NotImplementedException();

    /// <inheritdoc />
    [HttpPost, Route("fulfillment_orders/{fulfillment_order_id:long}/cancellation_request/accept.json")]
    [ProducesResponseType(typeof(FulfillmentOrderItem), StatusCodes.Status200OK)]
    public override Task AcceptCancellationRequest([Required] AcceptCancellationRequestRequest request, long fulfillment_order_id)
    {
        throw new NotImplementedException();
    }
    ...
    [ProducesResponseType(typeof(FulfillmentOrderItem), StatusCodes.Status200OK)]
    public override Task RejectCancellationRequest([Required] RejectCancellationRequestRequest request, long fulfillment_order_id)
    {
        throw new NotImplementedException();
    }
}
