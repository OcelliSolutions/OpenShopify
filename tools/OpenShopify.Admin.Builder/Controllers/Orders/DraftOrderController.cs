...
namespace OpenShopify.Admin.Builder.Models
{
    ...
    public partial record DraftOrderOrig
    {
        ...
        /// <summary>
        /// The customer resource, which contains information about the customer. Learn more about [loading and removing customers](#loading-and-removing-customers). For more information about the `customer` resource, see the [Customer](/api/admin-rest/current/resources/customer) documentation.
        /// </summary>
