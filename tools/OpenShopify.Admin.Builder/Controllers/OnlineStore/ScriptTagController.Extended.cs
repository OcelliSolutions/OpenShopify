...
public class ScriptTagController : ScriptTagControllerBase
{
    ...
    public override Task ListScriptTags(DateTimeOffset? created_at_max = null, DateTimeOffset? created_at_min = null,
        string? fields = null, int? limit = null, string? page_info = null,
        long? since_id = null, string? src = null, DateTimeOffset? updated_at_max = null,
    ...
    /// <inheritdoc />
    [HttpGet]
    [Route("script_tags/count.json")]
    [ProducesResponseType(typeof(CountItem), StatusCodes.Status200OK)]
    public override Task CountScriptTags(string? src = null) => throw new NotImplementedException();

    /// <inheritdoc />
    [HttpGet]
    [Route("script_tags/{script_tag_id:long}.json")]
    ...
    [Route("script_tags/{script_tag_id:long}.json")]
    [ProducesResponseType(typeof(ScriptTagItem), StatusCodes.Status200OK)]
    public override Task DeleteScriptTag([Required] long script_tag_id) => throw new NotImplementedException();
}